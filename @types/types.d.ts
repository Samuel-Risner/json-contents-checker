...
type SmallCheckFunction = (jsonObject: {
    [key: string]: any;
}) => CheckReturn;
...
export { CheckReturn, ErrorFunction, SuccessFunction, JsonObject, SmallCheckFunction, VerySmallCheckFunction, BigCheckFunction, Middleware };
