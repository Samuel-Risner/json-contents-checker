...
declare function chainChecksMiddleware(errorFunction: ErrorFunction, successFunction: SuccessFunction, jsonObject: JsonObject, ...checks: CheckFunction[]): Middleware;
